  ...
  return (
    <div className="space-y-12">
        ...
        <MotionStagger staggerDelay={0.12} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {certifications?.map((cert) => (
            <MotionStaggerItem key={cert?.id}>
              <div className="bg-card rounded-xl p-6 shadow-soft-hover hover:shadow-lg transition-shadow duration-300">
      ...
      <div>
        ...
        <MotionStagger staggerDelay={0.12} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {achievements?.map((achievement) => (
            <MotionStaggerItem key={achievement?.id}>
              <div className="bg-card rounded-xl p-6 shadow-soft-hover text-center">
