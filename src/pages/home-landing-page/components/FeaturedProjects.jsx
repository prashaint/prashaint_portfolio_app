      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {featuredProjects?.map((project) => (
            <div
              key={project?.id}
              className="group relative bg-card rounded-xl overflow-hidden shadow-soft-hover hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2"
