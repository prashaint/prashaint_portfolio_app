  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 right-4 z-50 p-3 sm:p-4 rounded-full bg-green-600 text-white shadow-lg hover:scale-110 transition-transform active:scale-95"
      ...
      {isOpen && (
        <div className="fixed inset-x-4 sm:right-4 sm:left-auto bottom-32 z-50 sm:w-96 bg-gray-900 rounded-lg shadow-2xl overflow-hidden animate-slide-in-from-bottom">
